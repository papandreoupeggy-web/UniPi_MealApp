...
//needed imports for APIs calling and returning
...
//start of class MealDBService for HTTP and API communication
public class MealDBService {
    private final String API_URL;
    private final String API_KEY;

    //costructor for API configuration
    public MealDBService(String API_URL, String API_KEY) {
        this.API_URL = API_URL;
        this.API_KEY = API_KEY;
    }

    // Private helper method to get API data - uribulder
    private Meals getAPIData(String apiFunction, String parameter) throws MealAPIException {
        try {
            ...
            //parameters addition according to API methods
         ...
         //prepare HHT GET request
            final URI uri = uriBuilder.build();
            final HttpGet getRequest = new HttpGet(uri); //HTTPClient
            ...
            try (CloseableHttpClient httpclient = HttpClients.createDefault();
              ...
              //convert API responses to string
    ...
    //3 public methods for APIs response
    // Get meals by name
