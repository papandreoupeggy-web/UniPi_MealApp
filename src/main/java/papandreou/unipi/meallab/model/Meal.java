...
import java.util.ArrayList; //use to create array list//
import java.util.List; //use to create list//

public class Meal {

    // private variables as shown on the JSON file//
    ...
    // private list of 1-20 Ingredients as shown on the JSON file//
    ...
    // private list of 1-20 Measures as shown on the JSON file//
    ...
    // Inner class to represent an Ingredient with its measure//
    public static class Ingredient {
     ...
     // Getters//
        ...
        @Override //use override to avoid compiler errors//
        // String representation for the final display//
        public String toString() { 
            return name + " (" + measure + ")"; //return name and measure of ingredient//
        }// End of toString//
    }

    // Method to get the list of ingredients with their measures//
    public List<Ingredient> getIngredientsTable() {
        List<Ingredient> list = new ArrayList<>();
        
        // Add ingredients and measures to the list if they are valid, 1-20 as shown in the JSON file//
        addIngredientIfValid(list, strIngredient1, strMeasure1);
        addIngredientIfValid(list, strIngredient2, strMeasure2);
        addIngredientIfValid(list, strIngredient3, strMeasure3);
        addIngredientIfValid(list, strIngredient4, strMeasure4);
        addIngredientIfValid(list, strIngredient5, strMeasure5);
        addIngredientIfValid(list, strIngredient6, strMeasure6);
        addIngredientIfValid(list, strIngredient7, strMeasure7);
        addIngredientIfValid(list, strIngredient8, strMeasure8);
        addIngredientIfValid(list, strIngredient9, strMeasure9);
        addIngredientIfValid(list, strIngredient10, strMeasure10);
        addIngredientIfValid(list, strIngredient11, strMeasure11);
        addIngredientIfValid(list, strIngredient12, strMeasure12);
        addIngredientIfValid(list, strIngredient13, strMeasure13);
        addIngredientIfValid(list, strIngredient14, strMeasure14);
        addIngredientIfValid(list, strIngredient15, strMeasure15);
        addIngredientIfValid(list, strIngredient16, strMeasure16);
        addIngredientIfValid(list, strIngredient17, strMeasure17);
        addIngredientIfValid(list, strIngredient18, strMeasure18);
        addIngredientIfValid(list, strIngredient19, strMeasure19);
        addIngredientIfValid(list, strIngredient20, strMeasure20);
        
        return list; // Return the final list of ingredients with measures//
    }

    // additional method to add ingredient if valid//
    private void addIngredientIfValid(List<Ingredient> list, String ingredient, String measure) {
        if (ingredient != null && !ingredient.trim().isEmpty()) {
            // Ignore null or empty ingredients//
            String m = (measure != null) ? measure : "";
            list.add(new Ingredient(ingredient, m));
        }
    }
    ...
    public Object getStrMealAlternate() { return strMealAlternate; }
    public void setStrMealAlternate(Object strMealAlternate) { this.strMealAlternate = strMealAlternate; }

    public Object getStrTags() { return strTags; }
    public void setStrTags(Object strTags) { this.strTags = strTags; }  

    public String getStrSource() { return strSource; }
    public void setStrSource(String strSource) { this.strSource = strSource; }

    public Object getStrImageSource() { return strImageSource; }
    public void setStrImageSource(Object strImageSource) { this.strImageSource = strImageSource; }

    public Object getStrCreativeCommonsConfirmed() { return strCreativeCommonsConfirmed; }
    public void setStrCreativeCommonsConfirmed(Object strCreativeCommonsConfirmed) { this.strCreativeCommonsConfirmed = strCreativeCommonsConfirmed; }
